...
const Tabs = ({tabs, onAddTab, onRemoveTab, onSelectTab, currentTab}) => {
  ...
  return (
    <div className='px-20 draggable-element'>
      <div
        className="relative flex flex-row h-9 max-h-9 bg-slate-200 dark:bg-slate-800 text-sm font-light text-slate-800 dark:text-slate-200 overflow-x-scroll overflow-y-hidden"
      >
        {
          [
            (
